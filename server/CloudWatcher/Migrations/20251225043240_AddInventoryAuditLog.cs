        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VariantPrice = table.Column<decimal>(type: "numeric", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PartVariants_Parts_PartId",
                        column: x => x.PartId,
                        principalTable: "Parts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PartVariants_Parts_PartId1",
                        column: x => x.PartId1,
                        principalTable: "Parts",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AgentDecisions_Requests_RequestId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CloudFileReferences", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CloudFileReferences_Requests_RequestId",
                        column: x => x.RequestId,
                        principalTable: "Requests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RequestMetadata", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RequestMetadata_Requests_RequestId",
                        column: x => x.RequestId,
                        principalTable: "Requests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderApprovals_Users_ApproverId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ResponseMetadata_Responses_ResponseId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastInventoryCheck = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    PartId1 = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Inventory_Parts_PartId1",
                        column: x => x.PartId1,
                        principalTable: "Parts",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                name: "PartConsumables",
                columns: table => new
                {
                    PartId = table.Column<Guid>(type: "uuid", nullable: false),
                    LocationId = table.Column<Guid>(type: "uuid", nullable: false),
                    QuantityConsumed = table.Column<int>(type: "integer", nullable: false),
                    LastConsumedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PartConsumables", x => new { x.PartId, x.LocationId });
                    table.ForeignKey(
                        name: "FK_PartConsumables_Locations_LocationId",
                        column: x => x.LocationId,
                        principalTable: "Locations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PartConsumables_Parts_PartId",
                        column: x => x.PartId,
                        principalTable: "Parts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StockLevels", x => new { x.PartId, x.LocationId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AgentDecisions_AgentName",
                table: "AgentDecisions",
                column: "AgentName");

            migrationBuilder.CreateIndex(
                name: "IX_AgentDecisions_RequestId",
                table: "AgentDecisions",
                column: "RequestId");

            migrationBuilder.CreateIndex(
                name: "IX_AgentDecisions_Timestamp",
                table: "AgentDecisions",
                column: "Timestamp");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CloudFileReferences_Provider",
                table: "CloudFileReferences",
                column: "Provider");

            migrationBuilder.CreateIndex(
                name: "IX_CloudFileReferences_RequestId",
                table: "CloudFileReferences",
                column: "RequestId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeviceConnections_ConnectedAt",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderApprovals_ApproverId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PartConsumables_LocationId",
                table: "PartConsumables",
                column: "LocationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PartVariants_PartId",
                table: "PartVariants",
                column: "PartId");

            migrationBuilder.CreateIndex(
                name: "IX_PartVariants_PartId1",
                table: "PartVariants",
                column: "PartId1");

            migrationBuilder.CreateIndex(
                name: "IX_PartVariants_VariantCode",
                table: "PartVariants",
                column: "VariantCode");

            migrationBuilder.CreateIndex(
                name: "IX_RequestMetadata_RequestId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ResponseMetadata_ResponseId",
