...
tools:
  ['vscode', 'execute', 'read', 'edit', 'search', 'web', 'agent', 'memory', 'todo', 'mcp_mcp_docker_search_nodes', 'mcp_mcp_docker_add_observations', 'mcp_mcp_docker_get_overview', 'mcp_mcp_docker_search_tasks', 'mcp_mcp_docker_update_task', 'github.vscode-pull-request-github/activePullRequest', 'github.vscode-pull-request-github/openPullRequest', 'github.vscode-pull-request-github/suggest-fix']
...
- `/memories/dev/smart-execute/` (read-only for execution context)
- `/memories/system/` (read-only)

**Store:** Review insights, root-cause analyses, prompt update effectiveness, cycle evaluations.
...
- 10-cycle evaluation reports (systemic)
  ...
  # Total: ~30 tools (review is analysis-focused, not execution)
  # Core: vscode, execute, read, edit, search, web, agent, memory, todo
  # MCP Docker: limited to review/analysis (5 tools)
  # GitHub: PR review (3 tools)