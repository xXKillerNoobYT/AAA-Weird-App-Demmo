...
tools:
  ['vscode', 'memory', 'mcp_mcp_docker_create_task', 'mcp_mcp_docker_get_overview', 'mcp_mcp_docker_search_tasks', 'mcp_mcp_docker_update_task', 'mcp_mcp_docker_add_observations', 'mcp_mcp_docker_mcp-find', 'mcp_mcp_docker_mcp-add', 'mcp_mcp_docker_mcp-remove', 'mcp_mcp_docker_mcp-config-set']
...
- `/memories/dev/smart-review/` (read-only)
- `/memories/system/` (read-only)

**Store:** Orchestration logs, cycle iterations, handoff timing, version sync validations.
